...
POINT_READER_REQUEST_VERSION = "phase_a_evidence_point_reader_request_v4"
...
POINT_READER_METHOD_TEXT = (
    ...
    "observed behavior or several purchased units into several repurchases. "
