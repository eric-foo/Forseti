...
evidence. Kinds here are KEYWORD-TIER ONLY: the semantic residue cache
...
known = {(r["platform"], r["display_name"].lower()) for r in feed["creators"]}
