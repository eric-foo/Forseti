...
| Review the frozen aggregation of adjudicated delegated review-and-patch episode yield across the recent 100-PR window | `delegated_review_patch_yield_backtest_2026_08_08_v0.md` |
