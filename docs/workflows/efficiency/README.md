...
| Review the frozen backtest of whether falsifiable-invariant authoring would have caught adjudicated architecture-review defects | `architecture_falsifiable_invariant_backtest_2026_08_08_v0.md` |
