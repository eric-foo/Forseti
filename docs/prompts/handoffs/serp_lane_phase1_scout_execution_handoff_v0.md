...
1. `docs/research/serp_lane_competitor_scout_20260728/README.md` —
   reading order and the authority note. The LIVING surface is operator
   staging `C:\tmp\forseti-serp-lane\`; if it diverges from the repo
   snapshot, staging is ahead.
